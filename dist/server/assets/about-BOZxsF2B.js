...
import "node:stream";
const landscape = "/assets/ashram-landscape-LfuEt1cm.jpg";
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative isolate", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: landscape, alt: "Ashram landscape", className: "absolute inset-0 -z-10 h-full w-full object-cover opacity-80" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10 bg-gradient-to-b from-[oklch(0.92_0.05_82_/_0.4)] to-[oklch(0.92_0.05_82)]" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-5xl px-6 py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "om-divider mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "deva text-2xl", children: "॥ परिचय ॥" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[oklch(0.91_0.05_80_/_0.5)] py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid gap-6 md:grid-cols-2", children: [{
        ...
        t: "Dharma & Donation",
        d: "Living a life guided by righteousness and compassionate giving."
      }, {
        t: "Vasudhaiva Kutumbakam",
        d: "Honoring all living beings as part of one universal family."
      }, {
        t: "Purification",
        d: "Inspiring individuals to purify thoughts and actions across lifetimes."
      }].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ink-card rounded-sm p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl text-[var(--vermilion)]", children: p.t }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-base leading-relaxed", children: p.d })
      ] }, p.t)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative isolate overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: aarti, alt: "Aarti ceremony at temple", className: "h-[60vh] w-full object-cover" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid place-items-center bg-[oklch(0.2_0.08_30_/_0.55)] text-center text-[var(--parchment)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "deva text-2xl text-[var(--gold)]", children: "॥ श्रद्धावान् लभते ज्ञानम् ॥" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 font-display text-4xl", children: "Faith. Knowledge. Service." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg italic leading-relaxed", children: "A society that embodies the divine essence of Sanatan Dharma in every generation." })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-5xl px-6 py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "om-divider mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "deva text-2xl", children: "॥ स्थान ॥" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl text-[var(--vermilion)]", children: "Where We Reside" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 grid gap-10 md:grid-cols-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "vintage-frame", children: /* @__PURE__ */ jsxRuntimeExports.jsx("iframe", { title: "Dev Dham Anandashram Location", src: "https://www.google.com/maps?q=Dev+Dham+Anandashram&output=embed", className: "h-72 w-full", loading: "lazy" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative isolate overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: shikhara, alt: "Temple shikhara sunrise", className: "h-[40vh] w-full object-cover" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid place-items-center bg-[oklch(0.2_0.08_30_/_0.45)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-[var(--parchment)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl", children: "Walk with us on the eternal path" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/donate", className: "btn-vintage mt-6 inline-block rounded-sm px-7 py-3 text-sm", children: "Become a Member" })
      ] }) })
    ] })
  ] });
}
