...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Our community is built on Sanatan Dharma, soul, donation and the eternal cycle of life guided by Rashtriya Sanatan Sayang Sebak Sangha." },
    ],
  }),
  component: About,
});
