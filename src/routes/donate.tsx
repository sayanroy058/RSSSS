...
export const Route = createFileRoute("/donate")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Become a Patron, Life, Executive, Ordinary or Special Donor Member of Rashtriya Sanatan Sayang Sebak Sangha and support Sanatan Dharma." },
    ],
  }),
  component: Donate,
});
      ...
      <section className="relative isolate">
        ...
        <div className="mx-auto max-w-4xl px-6 py-24 text-center">
          ...
          <p className="mt-6 text-xl italic leading-relaxed">
            Walk hand in hand with Rashtriya Sanatan Sayang Sebak Sangha - your donation sustains the eternal flame of Sanatan Dharma.
          </p>
        </div>
      </section>
